...
export default function App() {
  ...
  // --- CRITICAL FIX 2: ROBUST EXIT LOGIC ---
  const handleExitToWelcome = (fromBackPress = false) => {
    ...
    if (fromBackPress) {
        ...
        // SOLUTION: Hard Reset. This ensures a clean history stack (length 1)
        // regardless of how many times the user refreshed the page.
        ...
        <div className="flex flex-1 overflow-hidden relative">
            ...
            `}>
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50 text-xs font-medium space-y-2">
                    ...
                    {/* --- UI FIX: EMPTY SQUARE FOR CURRENT INDICATOR --- */}
