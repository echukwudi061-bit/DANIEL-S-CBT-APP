...
// --- Constants ---
const appId = "anatomy_cbt_main"; // Unique ID for this specific test instance in DB
...
export default function DanielAnatomyCBT() {
  ...
  useEffect(() => {
    const initAuth = async () => {
      // Use "window as any" to safely access the global variable without TS errors
      const initialToken = (window as any).__initial_auth_token;
      if (typeof initialToken !== 'undefined' && initialToken) {
    ...
    <div className="font-sans text-gray-900">
        ...
        {view === 'admin' && (
             <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row relative">
                ...
                <div
                className="bg-gray-900 text-white w-full md:w-64 flex-shrink-0">
