...
export default function App() {
  ...
  // 1. Questions (Check storage first, else use INITIAL_QUESTIONS)
  const [questions, setQuestions] = useState(() => {
    const saved = localStorage.getItem('cbt_questions');
    return saved ? JSON.parse(saved) : INITIAL_QUESTIONS;
  });

  // 2. App Name (Default updated to DANIEL'S ANATOMY CBT APP)
  const [appName, setAppName] = useState(() => {
    return localStorage.getItem('cbt_appName') || "DANIEL'S ANATOMY CBT APP";
  });

  // 3. Test Title (Default updated to ANAT 213)
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Duration Setting (Now Changeable) */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
