...
// --- REUSABLE STYLES ---
const guestIdStyle = "bg-blue-50 text-blue-800 text-[10px] font-bold rounded-full border border-blue-100 px-3 py-1 inline-block";
...
export default function App() {
  ...
  const handleSubmit = () => {
    ...
    const newResult = {
      id: Date.now(),
      guestId: guestId, // Save the guest ID with the result
      score: finalScore,
      total: totalPossible,
                     ...
                     <tr>
                      ...
                      testResults.map((res) => (
                       <tr key={res.id} className="hover:bg-gray-50">
                         {/* ADMIN GUEST ID */}
                         <td className="p-3 text-blue-600 font-bold text-xs">{res.guestId || "N/A"}</td>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans text-gray-900 relative">
        ...
        <div className="absolute top-4 right-4">
            <span className={guestIdStyle}>{guestId}</span>
        </div>
      ...
      <div className="min-h-screen bg-gray-50 p-4 font-sans text-gray-900 overflow-y-auto">
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl text-center">
            ...
            {/* RESULT SCREEN GUEST ID (BELOW COMPLETED TEXT) */}
            <div className="mb-6">
                <span className={guestIdStyle}>{guestId}</span>
            </div>
